...
int Player::StateSetWire(void)
{
	...
	if ((cnt % 20) == 0)
	{
		//lpEffect.AddEffectList("wireEff/溜め1.png", VECTOR2(192, 192), VECTOR2(5, 2), VECTOR2(0, 0), 10, 4, VECTOR2(pos.x - 50, pos.y - 64));
	...
	if (state_p == STATE_P::SET_WIRE)
	{
		...
		{
			//ワイヤーエフェクト(仮)
			lpEffect.AddEffectList("wireEff/wire1.png", VECTOR2(192, 192), VECTOR2(5, 3), VECTOR2(0, 0), 15, 3, VECTOR2(pos.x, pos.y - 70));
